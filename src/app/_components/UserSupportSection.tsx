  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Support Banner */}
        <div className="w-full relative rounded-3xl overflow-hidden flex items-center justify-center min-h-[448px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[448px]">
          ...
          {/* Desktop Background */}
          <div
            className="w-full h-full absolute inset-0 hidden lg:block"
            style={{
          ...
          <div className="absolute top-4 left-4 sm:top-6 sm:left-6 lg:top-8 lg:left-8 opacity-30">
            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24">
              ...
              >
                <path
                  d="M20,20 Q30,10 40,20 Q50,30 40,40 Q30,50 20,40 Q10,30 20,20 Z"
                  opacity="0.3"
                />
                <path
                  d="M60,60 Q70,50 80,60 Q90,70 80,80 Q70,90 60,80 Q50,70 60,60 Z"
                  opacity="0.2"
                />
              </svg>
            </div>
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 lg:bottom-8 lg:right-8 opacity-30">
            <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28">
              ...
              >
                ...
                />
                <path
                  d="M55,25 Q65,15 75,25 Q85,35 75,45 Q65,55 55,45 Q45,35 55,25 Z"
                  opacity="0.3"
                />
                <path
                  d="M25,65 Q35,55 45,65 Q55,75 45,85 Q35,95 25,85 Q15,75 25,65 Z"
                  opacity="0.2"
                />
              </svg>
            </div>
