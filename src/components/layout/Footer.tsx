...
//           {/* 1. Brand Info (Full width on mobile, 1 col on desktop) */}
//           <div className="col-span-2 lg:col-span-1 space-y-6">
//             <div className="flex items-center gap-2">
//                <div className="flex flex-col leading-none">
//                  <span className="text-2xl font-bold text-white">Sapana</span>
//                  <span className="text-xs font-bold text-white tracking-[0.2em]">FERTILIZER</span>
//                </div>
//             </div>
            
//             <p className="text-sm text-gray-200 leading-relaxed max-w-xs">
//               Winter-wise Farming: Curated for Crops, Carefully Chosen for You. Winter-wise Farming: Curated for Crops, Carefully Chosen for You.
//             </p>
...
//             <ul className="space-y-4 text-sm text-gray-200">
//               {['Fungicide', 'Herbicide', 'Insecticide', 'Fertilizer', 'Redoneticide', 'Seeds'].map(link => (
//                 <li key={link} className="hover:text-white cursor-pointer">{link}</li>
//               ))}
//             </ul>
//           </div>

//           {/* 4. Contact Details (Full width on mobile, 1 col on desktop) */}
...
//           {/* Copyright (Full width on mobile, 3 cols on desktop) */}
//           <div className="col-span-2 lg:col-span-3 border-t border-white/20 pt-8 mt-8 text-sm text-gray-300 z-20 relative">
//             @2025 Sapana Fertilizers Pvt Ltd
//           </div>

//         </div>
//       </div>

//       {/* Decorative Image - Updated Sizes */}
//       <div className="absolute right-0 bottom-0 z-0 pointer-events-none">
//         {/* UPDATED SIZES:
//            - Mobile: w-[160px] (was 180px)
//            - Tablet: md:w-[240px] (was 300px)
//            - Desktop: xl:w-[320px] (was 400px - Reduced per request)
//         */}
//         <img 
