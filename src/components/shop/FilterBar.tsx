...
const FilterBar = ({ filters, onFilterChange }: FilterBarProps) => {
  ...
  // [!code changed] REMOVED "Logic Sync" Effect entirely. 
  // We rely on the Parent to handle URL changes, preventing the reset loop.

  // --- VISUAL SYNC ONLY (URL -> UI Inputs) ---
  // This ensures inputs show the correct values from URL, but NEVER calls onFilterChange.
  useEffect(() => {
    ...
    // Sync Category Dropdown View (Auto-open parent)
        ...
        <div className="w-full"> 
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 w-full">
            <div 
                ...
                // Removed maxWidth to prevent layout wrapping bugs
