...
//         <h2 className="text-center text-[#000000] mb-6 lg:mb-10 text-2xl font-bold mt-4 lg:mt-10"
//         style={{ fontFamily: '"Google Sans", sans-serif' }}>
//           {title || "Seasonal Problem & Solutions"}
//         </h2>
    ...
    <section className="w-full flex justify-center pt-12 pb-12 lg:pb-16 font-jakarta bg-white">
      ...
      <div className="w-full max-w-[1344px] h-auto flex flex-col items-center relative px-4 lg:px-0">
        ...
        ">
          ...
          {/* Question Panel */}
          <div className="
              relative shrink-0 flex flex-col justify-center items-center text-center group
              bg-[#FFE989]
              w-[96%] max-w-[357px] md:max-w-none md:w-[96%]
              ...
              lg:w-[504px] lg:min-w-[504px] lg:h-[348px] lg:rounded-[12px] lg:ml-6
          ">
              {/* [!code changed] TOP QUOTE: No BG, Responsive Size (35x27 mobile, 84x62 desktop) */}
              <div 
                className="
                  absolute 
                  left-0 lg:left-6 
                  -top-[13px] lg:-top-[31px] 
                ...
                "
              >
                  <Quote className="text-white fill-white rotate-180 w-[35px] h-[27px] lg:w-[80px] lg:h-[62px]" />
              </div>
              ...
              {/* [!code changed] BOTTOM QUOTE: No BG, Responsive Size (35x27 mobile, 84x62 desktop) */}
              <div 
                className="
                  absolute 
                  right-0 lg:right-6 
                  -bottom-[13px] lg:-bottom-[31px] 
                ...
                "
              >
                  <Quote className="text-white fill-white w-[35px] h-[27px] lg:w-[80px] lg:h-[62px]" />
              </div>
          </div>
