...
//                       <p className="text-[#4D4D4D] text-[14px] min-[834px]:text-[15px] font-semibold leading-[26px] tracking-[0.01em] font-jakarta max-w-[283px] min-[834px]:max-w-md mx-auto min-[834px]:mx-0">
...
//               {/* [!code changed] FIX: Switched from Scrollable Flex to Static Grid */}
...
//                               `}
//                               /* ^ Removed fixed width 'w-[180px]' and 'shrink-0' */
//                          >
