...
//       {/* [!code changed] Increased mobile height from 539px to 820px to fit 2 rows */}
//       <div className="relative w-full h-[820px] min-[834px]:h-[648px] overflow-hidden">
...
//                                 className={`
//                                     w-full min-[834px]:w-[180px] min-[834px]:md:w-auto shrink-0
//                                     /* [!code changed] Logic: Hide 5th item (index 4) on mobile to show 2x2 grid */
...
//                 {/* Mobile Button - Custom Styling per specs */}
//                 <div className="min-[834px]:hidden flex justify-center w-full px-4 mt-auto absolute bottom-[80px] left-0">
//                     <button 
//                         className="flex items-center justify-center gap-[4px] bg-[#003C22] text-white rounded-[8px] transition-colors shadow-sm"
//                         style={{
//                             width: '113px',
...
//          Changed 'h-[820px]' to 'h-auto min-h-[820px] pb-10' 
//          This allows the container to grow if text pushes content down, preventing overlap.
//       */}
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center min-[834px]:block">
            ...
            <div className="w-full max-w-[1297px] mx-auto flex flex-col gap-6 min-[834px]:gap-8 mt-[48px] min-[834px]:mt-[80px]">
                ...
                <div className="flex flex-col min-[834px]:flex-row justify-between items-center min-[834px]:items-end w-full px-4 xl:px-0 text-center min-[834px]:text-left">
                    ...
                    {/* [!code changed] Desktop Button wrapped in Link */}
                    <Link 
                      href="/shop?category=Seeds" // [!code highlight] Redirect to Shop with Seeds filter
                ...
                {/* [!code changed] Mobile Button wrapped in Link */}
                <div className="min-[834px]:hidden flex justify-center w-full px-4 mt-8">
                    <Link 
                        href="/shop?category=Seeds" // [!code highlight] Redirect to Shop with Seeds filter
                        className="flex items-center justify-center gap-[4px] bg-[#003C22] text-white rounded-[8px] transition-colors shadow-sm"
