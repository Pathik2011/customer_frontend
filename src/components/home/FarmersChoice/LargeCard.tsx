...
//   return (
//     <div 
//       className="bg-white border border-[#E0E2E7] rounded-[12px] flex flex-col items-center relative hover:shadow-lg transition-shadow overflow-hidden font-jakarta"
//       style={{ width: '100%', height: '100%' }}
//     >
//       {/* --- Image Section --- */}
//       {/* Centered at top with specific padding/margin */}
...
//       >
//         {/* Title */}
//         <h3 className="font-bold text-gray-900 text-[18px] lg:text-[22px] mb-2 lg:mb-3 leading-tight">
//           {item.title}
//         </h3>
...
//       {/* --- Footer Section --- */}
//       {/* [!code highlight] FIXED: Reduced margin-top (mt-auto -> mt-4) and adjusted bottom padding (pb-6) */}
//       <div className="mt-auto w-full pb-6 lg:pb-8 flex items-center justify-center gap-4 px-4">
...
//            <button 
//              className={`${BUY_BTN_CLASS} px-6 py-0 h-[40px] lg:h-[44px] text-[14px] lg:text-[16px] shrink-0`}
...
//       <div className="flex flex-col items-center text-center px-4" style={{ maxWidth: '290px', margin: '0 auto' }}>
//         <h3 className="font-bold text-gray-900 text-[18px] lg:text-[22px] mb-2 lg:mb-3 leading-tight">
//           {item.title}
//         </h3>
//         <p 
