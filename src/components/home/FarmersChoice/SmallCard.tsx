...
//       className="
//         group relative flex flex-col bg-white border border-[#E0E2E7] rounded-[12px] 
//         hover:shadow-lg transition-shadow font-jakarta shrink-0 overflow-visible cursor-pointer
//         w-[177px] h-[245px] lg:w-[240px] lg:h-[317px]
//       "
//     >
//       {/* Image Section */}
...
//           className="
//             text-gray-900 font-semibold truncate mb-1 lg:mb-2
//             text-[15px] lg:text-[18px] group-hover:text-[#003C22] transition-colors
//           "
//           title={item.title}
//         >
//           {item.title}
  ...
  return (
    <div 
      ...
      className="
        group relative flex flex-col bg-white border border-[#E0E2E7] rounded-[12px] 
        hover:shadow-lg transition-shadow font-jakarta shrink-0 overflow-visible cursor-pointer
        /* [!code highlight] Updated Widths for Responsiveness */
        w-full h-[245px] lg:h-[317px]
      "
    >
      {/* Image Section */}
      <div className="w-full flex justify-center items-center pt-4 lg:pt-8 pb-2 grow">
