...
//                 }}
//             >
//                 <span className="min-[834px]:hidden">{subtitle || "Stay updated with the latest farming techniques and product launches."}</span>
//                 <span className="hidden min-[834px]:inline">{subtitle || "Stay updated with the latest farming techniques and product launches."}</span>
//             </p>
//         </div>
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1298px] h-full relative z-10 flex flex-col items-center">
        ...
        >
          {/* Spacers for Centering */}
          {/* [!code changed] REMOVED Desktop Spacer to align videos correctly */}
          <div className="block lg:hidden shrink-0" style={{ width: 'calc(50vw - 153px)' }}></div>
